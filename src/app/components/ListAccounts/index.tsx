    ...
    return (
      <>
        <React.Fragment>
          ...
          <div>
            <div className="pull-left mb-mob-3">
              <Button
                onClick={() => this.addEmptyItem()}
                type="button"
                color="primary"
                className="mb-3 mr-2 "
                // href="./addlist-accounts"
              >
                F4- Thêm
              </Button>
              <Button type="button" color="primary" className="mb-3 mr-2 ">
                F5 -Sửa
              </Button>
              <Button type="button" color="primary" className="mb-3 mr-2 ">
                F6 -Xóa
              ...
              <ButtonGroup className="mb-3 mr-2">
                ...
                >
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownItem>
                      1. Xem tổng cộng số dư các tài khoản cấp 1
                    </DropdownItem>
                    <DropdownItem divider />
                    <DropdownItem>2. In danh mục tài khoản cấp 1 </DropdownItem>
                    <DropdownItem>
                      3. In danh mục tài khoản các cấp{' '}
                    </DropdownItem>
                    <DropdownItem>
                      4. Xuất Danh mục tài sản và chi tiết sang exel{' '}
                    </DropdownItem>
                    <DropdownItem divider />
                    <DropdownItem>
                      5. In hệ thống tài khoản sang chế độ{' '}
                    </DropdownItem>
                  </DropdownMenu>
                </ButtonDropdown>
              </ButtonGroup>
            ...
            <div className="pull-right mb-mob-3">
              <Button type="button" color="primary" className=" mb-3 mr-2 ">
                F8 -Khai báo tài khoản đồng bộ
              </Button>
              <Button type="button" color="primary" className="mb-3 mr-2 ">
                F9 - Mở chi tiết cấp 1
              </Button>
              <Button type="button" color="danger" className="mb-3 mr-2 ">
                Kết Thúc
              </Button>
            </div>
          </div>
